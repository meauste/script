...
public class Load : MonoBehaviour
{
    ...
    public void Update()
    {
        ...
        if (PlayerPrefs.HasKey(load1))
        {
            ...
            if (tnum >= 20)
            {
                l1textl.text = text.Substring(1, 20) + "…";
            }
            else
            {
                l1textl.text = text;
            }
            if (PlayerPrefs.HasKey(load1)&textti.s1nf == 1 & loadpage == SaveManager.s1nfl)
            {
        ...
        if (PlayerPrefs.HasKey(load2)&textti.s1nf == 2 & loadpage == SaveManager.s2nf)
        {
        ...
        if (PlayerPrefs.HasKey(load3)&textti.s1nf == 3 & loadpage == SaveManager.s3nf)
        {
        ...
        if (PlayerPrefs.HasKey(load4)&textti.s1nf == 4 & loadpage == SaveManager.s4nf)
        {
        ...
        if (PlayerPrefs.HasKey(load5)&textti.s1nf == 5 & loadpage == SaveManager.s5nf)
        {
        ...
        if (PlayerPrefs.HasKey(load6)&textti.s1nf == 6 & loadpage == SaveManager.s6nf)
        {
